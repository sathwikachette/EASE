...
function Result(props) {
  ...
  function textResult(val)
  {
    if(val>=0 && val<=4)
    {
      ...
      <br></br>
      <h2>Your Result:</h2>
      <h3>This indicate that you are healthy and you have very few adverse symptoms and
are functioning within the healthy range for the general population.</h3>
    ...
    else if(val>=5 && val<=10)
    {
      ...
      <br></br>
      <h2>Your Result:</h2>
      <h3>This indicate that you have few adverse symptoms and may experience only minor limitations or interference in your daily tasks and activities.</h3>
      </div>
        );
    }
    else if(val>=11 && val<=14)
    {
      ...
      <br></br>
      <h2>Your Result:</h2>
      <h3>This indicate that you may be experiencing some moderate symptoms, noticeable levels of interference and some limitations on your daily tasks and activities.</h3>
      </div>);
    }
    else{
      return(<div className="common">
      ...
      <br></br>
      <h2>Your Result:</h2>
      <h3>This indicate that you may be experiencing significant psychological or physical symptoms, marked levels of interference and limitations on your daily tasks and activities.</h3>
      </div>);
    }
  }
  ...
  return (
    ...
    >
      ...
      <br></br>
      <li>Make sure you have positivity around you and try making yourself happy all the time.</li>
      <br></br>
